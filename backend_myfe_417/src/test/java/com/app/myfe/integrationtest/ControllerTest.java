package com.app.myfe.integrationtest;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("myfe", n.getAttribute("Namespace"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM myfe.PetService");
    jdbcTemplate.execute("DELETE FROM myfe.PetOwner");
    jdbcTemplate.execute("DELETE FROM myfe.PetCareCenter");
    jdbcTemplate.execute("DELETE FROM myfe.Manager");
    jdbcTemplate.execute("DELETE FROM myfe.Document");
    jdbcTemplate.execute("DELETE FROM myfe.Pet");
     jdbcTemplate.execute("DELETE FROM myfe.PetCareCenterServices");
     jdbcTemplate.execute("DELETE FROM myfe.PetCareCenterBusinessHours");
     jdbcTemplate.execute("DELETE FROM myfe.PetOwnerPets");
     jdbcTemplate.execute("DELETE FROM myfe.PetCareCenterImages");
     jdbcTemplate.execute("DELETE FROM myfe.PetCareCenterPets");
